...
Claude Code용 스킬 플러그인 마켓플레이스입니다. 초보자용 시그니처 스킬(설치·한국어 글쓰기·엑셀·설치 검증)부터 프롬프트 작성·한국 공공데이터 API 연동·repo 정리의 실전 검증된 노하우까지 스킬로 묶어 한 번에 설치할 수 있게 했습니다. [claude-checkup](https://github.com/x77xdavid-prog) 프로젝트의 일부로, "설치 장벽 없이 바로 써보는" 무료 스킬 모음입니다.
...
AI 초보자·비개발자를 위해 만든 이 마켓의 대표 스킬 4종입니다. 공통 원칙: 한 번에 한 단계씩 진행하고, 검증을 통과하기 전에는 "완료"라고 선언하지 않습니다.
